...
<section class="hero-section py-12 md:py-16 relative overflow-hidden">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div class="logo-container flex justify-center lg:justify-end order-2 lg:order-1">
                <div class="logo-box relative flex flex-col items-center">
                    <!-- Glowing Background -->
                    <div class="logo-glow-bg absolute inset-0 rounded-full bg-gradient-to-tr from-yellow-200 via-yellow-100 to-white blur-xl opacity-60 scale-110 animate-pulse"></div>
                    <div class="logo-glow absolute inset-0 rounded-full bg-yellow-400 opacity-20 blur-2xl scale-105 animate-glow"></div>
                    
                    <!-- Logo with Hover Effect -->
                    <div class="logo-text relative z-10 transform hover:scale-110 transition-all duration-500 hover:rotate-3">
            ...
            <div class="text-center lg:text-left order-1 lg:order-2">
                ...
                <div class="hero-title-container mb-4 md:mb-6">
                    <h1 class="hero-title text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-800 leading-tight">
                        <span class="block animate-gradient-text bg-gradient-to-r from-yellow-700 via-red-600 to-yellow-500 bg-clip-text text-transparent relative">
                            أخبار 
                        ...
                        <span class="block mt-2 md:mt-4 text-red-700 animate-fade-in-delay text-lg md:text-xl lg:text-2xl font-semibold">
                            على مدار الساعة
                ...
                <div class="hero-description mb-6 md:mb-8">
                    <p class="text-base md:text-lg lg:text-xl text-gray-600 max-w-2xl mx-auto lg:ml-0 leading-relaxed animate-fade-in-delay2 relative">
                        <span class="quote-mark absolute -top-2 -right-2 text-yellow-400 text-2xl">"</span>
                        ...
                        <span class="quote-mark absolute -bottom-2 -left-2 text-yellow-400 text-2xl">"</span>
                    </p>
                </div>
    ...
    <!-- Scroll Indicator -->
    <div class="scroll-indicator absolute bottom-4 left-1/2 transform -translate-x-1/2 animate-bounce">
